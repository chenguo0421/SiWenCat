...
class SharepreferenceUtils {
    companion object{
         ...
         * @return key对应的值(long)
         */
        public fun getLong(context: Context, key: String, defaultValue: Int): Long {
            val sp = getSP(context)
         ...
         * @return key对应的值(long)
         */
        public fun getLong(context: Context, key: String): Long {
            val sp = getSP(context)
         ...
         */
        public fun getFloat(context: Context, key: String, defaultValue: Int): Float {
            val sp = getSP(context)
         ...
         * @return key对应的值(float)
         */
        public fun getFloat(context: Context, key: String): Float {
            val sp = getSP(context)
         ...
         * @param value
         */
        public fun put(context: Context, key: String, value: Any) {
            val sp = getSP(context)
            val editor = sp.edit()
         ...
         * @param key
         */
        public fun remove(context: Context, key: String) {
            val sp = getSP(context)
